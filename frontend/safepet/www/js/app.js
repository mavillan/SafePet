...
.config(function ($stateProvider, $urlRouterProvider,$authProvider) {
    ...
    // Satellizer config
    $authProvider.baseUrl = 'http://safepetapi.labcomp.cl:5000';//'http://localhost:5000';
...
.factory('userDogsResource', ['$resource', function($resource){
    return $resource("hhttp://safepetapi.labcomp.cl:5000/dogs/user/:id",{userId: "@id"},{update: {method: "PUT"}});
}])
